        ...
        <div class="header-block">
            <div class="social-text">
                <div class="social">
                    ...
                    <a href="https://www.facebook.com/UandMeMoving" target="_blank" class="i-social i-facebook"><img src="<?php bloginfo('template_url'); ?>/img/i-facebook.png" alt=""></a>
                    <a href="https://twitter.com/UandMeMoving" target="_blank" class="i-social i-twitter"><img src="<?php bloginfo('template_url'); ?>/img/i-twitter.png" alt=""></a>
                    <a href="https://plus.google.com/+UMeMovingandStorageWestPalmBeach" target="_blank" class="i-social i-google-plus"><img src="<?php bloginfo('template_url'); ?>/img/i-google.png" alt=""></a>
                </div>
